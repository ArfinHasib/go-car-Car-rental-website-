   ...
   return (
      <div className='bg-white'>
         ...
         <div className='wrapper'>
            <div className='relative bg-white px-10 sm:px-[76px] py-9 sm:py-[70px] mt-5 sm:-mt-[168px] min-h-[330px] shadow-lg rounded-xl flex flex-col gap-8'>
               <div className='flex flex-col xl:flex-row gap-5'>
                  ...
                  <LabelInput
                     ...
                     placeholder='Airport or Aneywhere'
                     icon={locationIcon}
                  />
                  <LabelInput
               ...
               <PrimaryButton
                  className='w-full lg:w-3/4 mx-0 lg:mx-auto'
                  small={false}
               >
                  Find your car
               </PrimaryButton>
